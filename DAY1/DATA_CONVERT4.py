...
a = int(a)
b = int(b)
print(a<b) # 비교연산자 활용, 참, 거짓 출력
print(a==b) # 비교연산자 활용, 참, 거짓 출력

n = int(input("정수인지 아닌지 판단: ")) 
print(bool(n)) # bool 함수로 출력, 참, 거짓 출력
print(not n) # not 함수로 출력, 결과의 반대를 출력
print(bool(int(a)) or bool(int(b))) # 한 개라도 참인 경우 참 출력
print(bool(int(a)) and bool(int(b))) # 둘 다 참인 경우 참 출력